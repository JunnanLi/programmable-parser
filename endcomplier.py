...
protoType_in_pkt_1 = [{'name': 'IDLE_P', 'subProto_list': \
# sub protocol list:
...
# 		...
# 	end
	[{'condition': 'metadata_in[31:16] == 16\'h0800', 'nextProto': 'IP_P', 'nextState': 'READ_PKT_2_S', 'regInfo': \
#metaReg list:
		[{'array': [0,1,2,3,4,5], 'b_start_reg': 127, 'b_end_reg': 80}, \
		{'array': [6,7,8,9,10,11], 'b_start_reg': 79, 'b_end_reg': 32}]},\
	{'nextProto': 'ARP_P', 'nextState': 'READ_PKT_TAIL_S', 'regInfo': \
		#metaReg list:
		[{'array': [0,1,2,3,4,5], 'b_start_reg': 127, 'b_end_reg': 80}, \
		{'array': [6,7,8,9,10,11], 'b_start_reg': 79, 'b_end_reg': 32}]}
]}]
...
protoType_in_pkt_2 = [{'name': 'IP_P', 'subProto_list': \
# sub protocol list:
	[{'condition': 'metadata_in[71:64] == 8\'h06', 'nextProto': 'TCP_P', 'nextState': 'READ_PKT_3_S', 'regInfo': \
#metaReg list:
...
protoType_in_pkt_3 = [{'name': 'TCP_P', 'subProto_list': \
# sub protocol list:
	[{'condition': '1', 'nextProto': 'TCP_P', 'nextState': 'READ_PKT_TAIL_S', 'regInfo': \
#metaReg list:
